...
public class CurrencyConvertorLocator extends org.apache.axis.client.Service implements ch.test.webservice.CurrencyConvertor {
    ...
    public ch.test.webservice.CurrencyConvertorSoap getCurrencyConvertorSoap() throws javax.xml.rpc.ServiceException {
    ...
    public ch.test.webservice.CurrencyConvertorSoap getCurrencyConvertorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	ch.test.webservice.CurrencyConvertorSoapStub _stub = new ch.test.webservice.CurrencyConvertorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ch.test.webservice.CurrencyConvertorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
            	ch.test.webservice.CurrencyConvertorSoapStub _stub = new ch.test.webservice.CurrencyConvertorSoapStub(new java.net.URL(CurrencyConvertorSoap_address), this);
                _stub.setPortName(getCurrencyConvertorSoapWSDDServiceName());
                return _stub;
            }
        }
